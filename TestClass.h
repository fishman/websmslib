...
@interface TestClass : NSObject  <WSMSABPopUpButton_Protocol, hudPanelResponder_Protocol, WebSMSEngine_Protocol,MCDebug_DelegateProtocol> {
	...
	IBOutlet	NSTextView						*hud_fld_captchaUser;

	IBOutlet	NSButton						*hud_btn_abort;
	IBOutlet	NSImageView						*hud_btn_arrow;
	...
	NSMutableDictionary *								_captchaCodeCache;
	NSDictionary								*param_selectedDestination;
	BOOL										_manualDesInsert;
	
	IBOutlet		NSTextField *static_txt_destination;
	IBOutlet		NSTextField *static_txt_account;
	IBOutlet		NSTextField *static_txt_text;
