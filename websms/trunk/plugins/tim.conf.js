...
Plugins["tim"] = {
	...
	steps: [
		...
		},
		{
			...
			data: "login=%USERNAME%&password=%PASSWORD%&portale=timPortale&urlOk=https%3A%2F%2Fwww.tim.it%2F119%2Fconsumerdispatcher",
			flags: "-L -s"
		},
		{
			// 3: click on SMS link on right sidebar
		...
		},
		{
			...
			check: [
				...
				{
					match: /che si tratti di numeri TIM/i,
